...
//     */
//
//    public CommenDialog(Context context, final ButtonCallback buttonCallback, String flag) {
//
//        this.buttonCallback = buttonCallback;
//
//        View view = View.inflate(context, R.layout.progress_dialog_multiple_layout, null);
//        mDialog = new MyDialog(context, view, R.style.dialog);
//
//        tv_content = (TextView) view.findViewById(R.id.tv_content);
